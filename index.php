...
<div class="modal" id="flashMatModal">
  <div class="box">
    <h3 id="flashMatTitle">📘 Flash Cards</h3>
    <div id="flashMatText" style="min-height:120px;margin:12px 0"></div>
    <div style="display:flex;justify-content:space-between">
      <button class="btn-light" onclick="prevFlash()">◀</button>
      <button class="btn-light" onclick="nextFlash()">▶</button>
    </div>
...
<div class="modal" id="adminModal">
  <div class="box">
    ...
    <div class="admin-row">
      ...
      <input id="admMateriaNew" placeholder="Nova matéria">
    </div>
    ...
    <div class="admin-row">
      ...
      <button class="btn-danger" onclick="adminDelMateria()">Excluir Matéria</button>
      ...
      mat.innerHTML=`
        <div class="materia-head">
          ...
          <div class="materia-right">
            <strong>${pct}%</strong>
            <button class="flash-btn" onclick="event.stopPropagation();openFlashMat('${m}')">📘</button>          </div>
        </div>
      `;
...
function cycle(o){
  ...
  // 🔹 atualiza visual imediato (SEM esperar reload)
  render();
...
function openFlashMat(m){
  ...
  flashMatIndex=0;
  flashMatTitle.textContent="📘 Flash Cards — "+m;
...
/* ADMIN */
function openAdmin(){
  if(email!==ADMIN_EMAIL){alert("Sem permissão");return}
